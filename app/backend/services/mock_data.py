...
async def initialize_mock_data():
    ...
    # After initial mock data load, sync records to fix any stale data
    try:
        from services.patient_sync import sync_patients, sync_programs
        await sync_programs()
        await sync_patients()
    except Exception as exc:
        logger.error("Data sync failed: %s", exc)
