...
@app.get("/api/config")
def api_config():
    """Public runtime JSON for the SPA — same shape as lambda_handler.handle_config_request body."""
    api_base = os.environ.get("VITE_API_BASE_URL") or os.environ.get("PYTHON_BACKEND_URL") or settings.backend_url
